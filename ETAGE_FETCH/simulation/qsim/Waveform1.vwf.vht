...
-- *****************************************************************************
-- Generated on "02/04/2024 20:09:45"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          ETAGE_FETCH
-- 
...
ENTITY ETAGE_FETCH_vhd_vec_tst IS
END ETAGE_FETCH_vhd_vec_tst;
ARCHITECTURE ETAGE_FETCH_arch OF ETAGE_FETCH_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL clk : STD_LOGIC;
SIGNAL datain : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL ext_in_hit : STD_LOGIC;
SIGNAL ext_out_hit : STD_LOGIC;
SIGNAL inst : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL inst_1 : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL is_tag_equal_ext : STD_LOGIC;
SIGNAL pc : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL tag_ext : STD_LOGIC_VECTOR(27 DOWNTO 0);
SIGNAL valid_ext : STD_LOGIC;
SIGNAL wren_ext : STD_LOGIC;
COMPONENT ETAGE_FETCH
	PORT (
	clk : IN STD_LOGIC;
...
-- list connections between master ports and signals
	clk => clk,
	datain => datain,
	ext_in_hit => ext_in_hit,
	ext_out_hit => ext_out_hit,
	inst => inst,
	inst_1 => inst_1,
	is_tag_equal_ext => is_tag_equal_ext,
	pc => pc,
	tag_ext => tag_ext,
	valid_ext => valid_ext,
	wren_ext => wren_ext
...
BEGIN
	...
	wren_ext <= '0';
WAIT;
END PROCESS t_prcs_wren_ext;

-- ext_in_hit
t_prcs_ext_in_hit: PROCESS
BEGIN
	ext_in_hit <= '0';
	WAIT FOR 160000 ps;
	ext_in_hit <= '1';
WAIT;
END PROCESS t_prcs_ext_in_hit;
END ETAGE_FETCH_arch;
