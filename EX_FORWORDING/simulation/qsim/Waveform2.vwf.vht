...
-- *****************************************************************************
-- Generated on "11/22/2023 22:34:03"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          EX_FORWARDING1
-- 
...
ENTITY EX_FORWARDING1_vhd_vec_tst IS
END EX_FORWARDING1_vhd_vec_tst;
ARCHITECTURE EX_FORWARDING1_arch OF EX_FORWARDING1_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
